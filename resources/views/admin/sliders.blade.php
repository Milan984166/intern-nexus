            ...
            <div class="col-md-8 col-sm-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.sliders') }}"><i class="icon-layers"></i> Sliders</a></li>
                        @if($id != 0)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="link" class="form-control" placeholder="eg: www.nester.com/about/" required value="{{ $id != 0 ? $slider->link : '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="file" name="image" class="bg-primary text-white form-control" required>

                                        </div>
                                        <div class="alert alert-warning"> Best Image Size 1349 X 600 PX </div>
                                    </div>
