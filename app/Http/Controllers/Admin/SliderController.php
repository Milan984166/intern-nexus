...
class SliderController extends Controller
{
    ...
    public function createslide(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $this->resize_crop_images(1349, 600, $image, $thumbPath."/slide_". $filename);
            $this->resize_crop_images(270, 120, $image, $thumbPath."/small_". $filename);
            $slider->image = $filename;
        }
        $request->status = isset($request->status) ? $request->status : '0';
        $slider->title = $request->title;
        $slider->subtitles = $request->subtitles;
    ...
    public function updateslide(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $this->resize_crop_images(1349, 600, $image, $folderPath."/thumbs/slide_".$filename);
            $this->resize_crop_images(270, 120, $image, $folderPath."/thumbs/small_".$filename);
        ...
        $slide->subtitles = $request->subtitles;
        $slide->buttonName = $request->buttonName;
