                        ...
                        <div class="row">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"><i
                                                class="fa fa-info fa-lg"></i> &nbsp;Site Title{{ PHP_INT_SIZE }}</span>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="phone" value="{{ $setting->phone }}" class="form-control"
                                           aria-label="Default"
                                           aria-describedby="inputGroup-sizing-default">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="mobile" value="{{ $setting->mobile }}"
                                           class="form-control" aria-label="Default"
                                           aria-describedby="inputGroup-sizing-default">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"><i
                                                class="fa fa-barcode fa-lg"></i>&nbsp; ABN</span>
                                    </div>
