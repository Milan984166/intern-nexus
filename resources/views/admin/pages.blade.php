        ...
        <li class="dd-item dd3-item" data-id="{{ $item->id }} ">
            ...
            <div class="dd3-content">
                ...
                <span class="content-right">
                    ...
                    <a href="{{ url('admin/pages/edit/'.base64_encode($item->id)) }}" class="btn btn-sm btn-outline-primary" title="Edit"><i class="fa fa-edit"></i></a>
        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right hidden-xs">
                    <a href="{{ $id != 0 ? route('admin.pages') : route('dashboard') }}" class="btn btn-sm btn-outline-primary" title="Go Back">
                ...
                <div class="tab-content mt-0">
                    ...
                    <div class="tab-pane {{ $id != 0 ? 'show active' : '' }}" id="addPage">
                        <div class="card">
                            ...
                            <div class="body mt-2">
                                <form method="post" action="{{ $id == 0 ? route('admin.pages.create') : route('admin.pages.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <?php $featured =  $id != 0 ? $page->featured : 0  ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="ckeditor" id="editor" name="excerpt">{{ $id != 0 ? $page->excerpt : '' }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="ckeditor" name="content">{{ $id != 0 ? $page->content : '' }}</textarea>
