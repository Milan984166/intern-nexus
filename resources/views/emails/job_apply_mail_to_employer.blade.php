			...
			<tr>
				<td style="padding-left: 40px;padding-right: 40px; padding-top: 40px; color: #095583;">
					<blockquote type="cite">
						Dear <b> {{ $jobApplyMessage['employer_name'] }}</b>,&nbsp;
						<div>
							<b>{{ $jobApplyMessage['jobseeker_name'] }}</b> has applied for a job "<a href="{{ $jobApplyMessage['job_url'] }}">{{ $jobApplyMessage['job_title'] }}</a>" that you have posted on <a href="https://inern-nexus.com">Intern Nexus</a> &nbsp;
						</div>&nbsp;
