	...
	<div class="block-header">
		<div class="row clearfix">
			...
			<div class="col-md-6 col-sm-12 text-right hidden-xs">
                <a href="{{ url('admin/job-seekers/profile/'.base64_encode($jobseeker->id).'/edit-education') }}" class="btn btn-sm btn-primary btn-round" title=""><i class="fa fa-graduation-cap"></i> Edit Education</a>
            </div>
		</div>
	</div>
	<div class="row clearfix">
			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex">
						<div class="details">
							<h5>Education</h5>
							<small>View Users Education Details</small>
						</div>                                
					</div>
				</div>
				<div class="card-body">
		                		...
		                		<div class="card-body">
		                			<div class="row">
            							<div class="col-md-12 col-sm-12 text-center hidden-xs">
            				                <a href="{{ url('admin/job-seekers/profile/'.base64_encode($jobseeker->id).'/edit-education') }}" class="btn btn-sm btn-outline-primary btn-round" title=""><i class="fa fa-graduation-cap"></i> Edit Education</a>
            				            </div>
		                			</div>
		                		</div>
		                	</div>
