					...
					<table border="0"  cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
						<tr>
							<td id="logo" style="text-align: center;" >
								<h2 style="color: #fff; padding-top: 15px;">Job Mail | Intern Nexus</h2>
							</td>
						</tr>
					</table>
					<!-- End Logo -->
			...
			<tr>
				<td style="padding-left: 40px;padding-right: 40px; padding-top: 40px; color: #095583;">
					<blockquote type="cite">
						Dear <b> {{ $jobStatusMessage['jobseeker_name'] }}</b>,&nbsp;
						<div>
							<p>Your application for job "<a href="{{ $jobStatusMessage['job_url'] }}">{{ $jobStatusMessage['job_title'] }}</a>" has been <b>{{ $jobStatusMessage['status'] }}</b> by <b>{{ $jobStatusMessage['employer_name'] }}</b>. &nbsp;</p>

							<p>You can now view employer details in your <b> Applied Jobs</b> Section of your Profile.</p>
						</div>&nbsp;
			...
			<tr>
				<td style="padding-left: 10px; color: #b6babd; line-height: 0.6;font-size: 14px;">
					<small>
						...
						<p>Please contact at <a href="mailto:{{ $jobStatusMessage['intern_nexus_email'] }}">{{ $jobStatusMessage['intern_nexus_email'] }}</a> for queries.</p>
					</small>
				</td>
			</tr>
		</table>
