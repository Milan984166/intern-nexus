...
<head>
    <meta charset="UTF-8">
    <title>{{ $setting->sitetitle }} || LogIn</title>
    <link rel="icon" href="{{ asset('storage/setting/favicon/thumb_'.$setting->favicon) }}" type="image/png"/>
    <link href="{{ asset('backend/login/style.css') }}" rel="stylesheet" type="text/css" media="all"/>
...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="email" name="email" value="{{ old('email') }}" id="loginEmail" maxlength="254"/>
    ...
    <div class="inputGroup inputGroup2">
        ...
        <label id="showPasswordToggle" for="showPasswordCheck">Show
            <input id="showPasswordCheck" name="remember" type="checkbox" {{ old('remember') ? 'checked' : '' }}/>
...
<div class="image-container">
    <div class="img-rush">
        <img src="{{ asset('backend/login/LOGO-final.png') }}" alt="ktmrush logo">
    </div>
    <div class="img-cty">
        <img src="{{ asset('storage/setting/favicon/thumb_'.$setting->favicon) }}" alt="nester logo">
    </div>
</div>
<p class="foot-note">Rush Admin 3.1.0</p>

<script type="text/javascript" src="{{ asset('backend/login/morphsvg.js') }}"></script>
<script type="text/javascript" src="{{ asset('backend/login/tweenMax.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('backend/login/script.js') }}"></script>
